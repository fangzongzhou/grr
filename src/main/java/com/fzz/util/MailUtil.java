...
public class MailUtil {
    ...
    public void sendMail(
            ...
            String password,
            String toaddress
    ) throws GeneralSecurityException, MessagingException, MalformedURLException {
        ...
        mdp.setContent("<a href=\"http://www.baidu.com\">百度</a>"+ "<img src = \"cid:logo_jpg\"></a>", "text/html;charset=utf-8");
        // 将mime协议bodypart添加
